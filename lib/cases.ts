...
export const brewCase = {
    ...
    tags: ["React Native", "TypeScript", "Tailwind CSS", "Expo", "Claude Code", "PlaywrightMCP", "GitHub"],
};
...
export const cases: CaseStudy[] = [
    {
        ...
        tags: ["JavaScript", "PHP", "Laravel", "Claude Code", "Codex", "MySQL", "Docker", "BackLog", "SourceTree"],
    },
    {
        no: "03",
        ...
        tags: ["React", "Next.js", "TypeScript", "Material UI", "Laravel", "MySQL", "Docker", "BackLog", "SourceTree", "Adobe XD", "Adobe Illustrator", "Adobe Photoshop", "PowerPoint"],
    },
    {
        no: "04",
        title: "卸売業向けシステム間連携システム開発",
        period: "2024年7月〜2025年4月（10ヵ月）",
        summary: "システム間連携システム開発案件のスタートから参加。主にデザイン・フロントエンド開発を担当。メンバー5名。",
        role: "モック作成（React/Tailwind CSS）／詳細設計／フロントエンド・バックエンド開発・修正／単体テスト",
        point: "プロジェクトのスタートから参加し、モック作成から実装までを一貫して担当。",
        tags: ["React", "TypeScript", "Tailwind CSS", "Laravel", "MySQL", "Docker", "BackLog", "SourceTree"],
    },
    {
        no: "05",
        title: "運送会社ホームページ制作",
    ...
    },
    {
        ...
        period: "2023年10月",
        summary:
            "スマートフォンで利用する社内向けワークフローシステムのモックを作成（5ページ）。",
    ...
    },
    {
        ...
        tags: ["React", "Next.js", "TypeScript", "Tailwind CSS", "MySQL", "Figma", "Docker", "BackLog", "SourceTree"],
    },
];
